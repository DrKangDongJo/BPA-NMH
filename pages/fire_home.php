...
<script>
$("#nav_center_section").append('<div class="col text-center white-text" id ="project_title"><div class="row"><h5 class="clear-input w-100 text-center m-0 mt-2" id="">FIRE DEPARTMENT</h5></div><div class="row"><p>Home - Admin <span id = "pop_up_nav"></span></p></div></div>')
$("#user-tools").removeClass("my-auto");
$("#user-tools").addClass("my-2");
$("#title_logo").append('<div class = "mx-2"style ="width:22px;height:90%;background-color:#ff3535"></div>')
