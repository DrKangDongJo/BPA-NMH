<div class="row p-5">
    <div class="row p-4 m-0 border-black">
        ...
        <button id="add-choice-btn" class="btn btn-primary">Add</button>
        ...
        <div class="row">
            <div class="col-5">
                ...
                <input type="text" name="storeys" class="mx-5 w-50" style="border:none; border-bottom: 1px solid black; outline: none;">

                <div class="d-flex align-items-center">
                    <p class="my-3 mx-1">PROPOSED DATE <br> START OF INSTALLATION</p>
                    <input type="text" name="start-date" class="mx-0 w-10" style="border:none; border-bottom: 1px solid black; outline: none; margin-top: 10px">
                </div>

                <div class="d-flex align-items-center">
                    <p class="my-3 mx-1">EXPECTED DATE <br> OF COMPLETION</p>
                    <input type="text" name="completion-date" class="mx-0 w-10" style="border:none; border-bottom: 1px solid black; outline: none;">
                </div>
            </div>
        </div>
        ...
        <div class="col-7">
            ...
            <div class="row">
                ...
                <div class="d-flex align-items-center">
                    <input type="text" name="area" class="mx-1 w-50 " style="border:none; border-bottom: 1px solid black; outline: none;">
